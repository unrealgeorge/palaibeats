...
Το `/radio add` θέλει το **απευθείας URL του stream**, όχι το site του
σταθμού και όχι link σε playlist αρχείο (`.pls`/`.m3u`). Πολλοί
σταθμοί δίνουν μόνο ένα playlist αρχείο — άνοιξέ το σε text editor και
ψάξε για κάτι σαν `File1=https://...`· αυτό είναι το URL που θες.
